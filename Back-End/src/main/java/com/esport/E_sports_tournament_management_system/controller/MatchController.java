...
public class MatchController {
    ...
    public Match addMatch(@RequestBody Match match) {
        System.out.println("📥 Reçu match : " + match.getTeam1().getName() + " vs " + match.getTeam2().getName());
        System.out.println("📊 Score : " + match.getResult().getTeamAScore() + " - " + match.getResult().getTeamBScore());
        System.out.println("🏆 Gagnant : " + match.getResult().getWinner().getName());
